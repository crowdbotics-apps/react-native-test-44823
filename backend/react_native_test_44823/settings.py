"""
Django settings for react_native_test_44823 project.
...
ROOT_URLCONF = 'react_native_test_44823.urls'
...
WSGI_APPLICATION = 'react_native_test_44823.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "react_native_test_44823 API",
    "DESCRIPTION": "API documentation for react_native_test_44823 App",
    "VERSION": "v1",
}
